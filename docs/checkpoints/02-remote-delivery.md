...
This procedure applies to the real consumer upgrade in this checkpoint and the corresponding upgrades in Checkpoints 3–6. It exercises Spec 02's existing desired configuration and ownership-specific commands; it does not add a new upgrade interface.
...
**Pactwright — Checkpoint 2 — Remote Delivery v13**
