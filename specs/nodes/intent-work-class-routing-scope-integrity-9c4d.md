---
id: intent-work-class-routing-scope-integrity-9c4d
type: intent
...
CLAUDE.md additions:
Work-class routing table. Every intent is classified at capture; its
...
Proposal market required; specialist critic panel required; lane
decomposition required; patch market available per lane; explicit
human gate at contract selection and again at integration.
Scope-integrity rules, applied whenever any review — contract, patch,
...
produced_by is never validated.
