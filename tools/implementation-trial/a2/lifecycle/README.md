...
run the report cites is committed at [`evidence/a2/lifecycle/run-all.log`](../../../../docs/research-logs/implementation-trial/evidence/a2/lifecycle/run-all.log). Set `WORK` to keep
